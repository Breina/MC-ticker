...
public class Tag {
     ...
     */
    public static Tag readFrom(InputStream is) throws IOException, NoSuchAlgorithmException {
    	
    	MessageDigest md = MessageDigest.getInstance("MD5");
    	
        DataInputStream dis = new DataInputStream(new DigestInputStream(new GZIPInputStream(is), md));
        ...
        // TODO miiiiiight create a collision
        tag.setHash(Arrays.hashCode(md.digest()));
    ...
    /**
     * Read a tag and its nested tags from a DataInputStream without GZIP.
     *
     * @param is stream to read from, like a FileInputStream
     * @return NBT tag or structure read from the InputStream
     * @throws IOException if there was no valid NBT structure in the InputStream or if another IOException occurred.
     */
    public static Tag createCompountTag(DataInputStream dis) throws IOException {
